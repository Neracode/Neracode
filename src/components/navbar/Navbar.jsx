...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    function handleMouseMove(event) {
      ...
      setNavbarIsHidden(
        !isDropdownActive && window.scrollY > 200 && mouseY > 150
      );
    ...
    <div
      ...
      <div className="container relative m-auto flex items-center justify-between">
        <Link
          to="/"
          className={`${
            !isDropdownActive ? 'max-md:ml-16' : 'max-md:ml-4'
