    ...
    <MyContainer
      ...
      <div className="flex-1">
        <div className="flex items-center gap-[1rem]">
          <LazyLoadImage src={iconsImages.star} alt="" />
          <div className="text-xl max-sm:text-sm text-[#B2A9A9]">
        ...
        <a
          ...
          rel="noreferrer"
          target="_blank"
          className="flex justify-center items-center text-lg mt-6 px-[1.5rem] py-[.5rem] border border-black rounded-full w-fit gap-[1rem] hover:bg-[#25263A] hover:text-[#FEFCFB] ease-in-out duration-300 group relative">
          <LazyLoadImage
            src={iconsImages.curl_arrow}
            alt=""
            className="absolute top-[-1.4rem] left-[10rem]"
          />
