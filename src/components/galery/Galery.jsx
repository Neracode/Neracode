        ...
        <div className="grid gap-4 grid-rows-[1fr,2fr] max-md:grid-rows-[1fr] max-md:grid-cols-2 w-full">
          <div className="overflow-hidden rounded-xl shadow-lg w-full h-full">
            <LazyLoadImage
              ...
              alt=""
              className="bg-gray-200 w-full bg-cover object-cover h-full duration-200 ease-[cubic-bezier(.75, .2, .2, 0.94)] transition-all delay-0 hover:scale-110"
            />
          </div>
          <div className="overflow-hidden rounded-xl shadow-lg w-full h-full">
            <LazyLoadImage
        ...
        <div className="grid gap-4 grid-rows-[1.8fr,1fr] max-md:grid-rows-[1fr] w-full">
          ...
          <div className="overflow-hidden rounded-xl shadow-lg w-full h-full">
            <LazyLoadImage
              ...
              alt=""
              className="bg-gray-200 w-full bg-cover object-cover h-full duration-200 ease-[cubic-bezier(.75, .2, .2, 0.94)] transition-all delay-0 hover:scale-110 max-md:hidden"
            />
          </div>
        </div>
        <div className="grid gap-4 grid-rows-[1fr,2fr] max-md:grid-rows-[1fr] max-md:grid-cols-2 w-full">
